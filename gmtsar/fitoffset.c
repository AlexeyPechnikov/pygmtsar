...
load_freq_xcorr(argv[3]);
   ...
   /* Open a temporary file for a.xyz */ 
	...
	rshift = n_coeff1_r - n_coeff2_r*(n_range2+n_range1)/(n_range2-n_range1) -n_coeff3_r*(n_range4+n_range3)/(n_range4-n_range3);
	ashift = n_coeff1_a - n_coeff2_a*(n_range2+n_range1)/(n_range2-n_range1) -n_coeff3_a*(n_range4+n_range3)/(n_range4-n_range3);
