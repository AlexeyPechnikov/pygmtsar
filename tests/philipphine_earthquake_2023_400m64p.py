# -*- coding: utf-8 -*-
"""Philipphine_earthquake_2023_400m64p.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ET8Fv4Q4flV-WL2T4H-62dM3UpC7WKqT

## PyGMTSAR Co-Seismic Interferogram: Philipphine earthquake M7.6, 2023
...
SCENES = ['S1A_IW_SLC__1SDV_20231204T212419_20231204T212446_051510_0637B9_8819',
	      'S1A_IW_SLC__1SDV_20231122T212419_20231122T212446_051335_0631BC_9483',
          'S1A_IW_SLC__1SDV_20231204T212353_20231204T212421_051510_0637B9_6181',
          'S1A_IW_SLC__1SDV_20231122T212354_20231122T212421_051335_0631BC_7F7C',
          'S1A_IW_SLC__1SDV_20231204T212444_20231204T212511_051510_0637B9_78AB',
          'S1A_IW_SLC__1SDV_20231122T212444_20231122T212511_051335_0631BC_F775']
POLARIZATION = 'VV'
ORBIT        = 'D'
SUBSWATH     = 123
...
# https://www.gdacs.org/report.aspx?eventtype=EQ&eventid=1403417
# Magnitude M 7.6
# Region    Philippines, 8.5266, 126.4487
# Date      2023-12-02 14:53 UTC
EPICENTER = [126.4487, 8.5266]
POI = gpd.GeoDataFrame(geometry=[shapely.geometry.Point(*EPICENTER)])
POI
...
data = sbas.open_data()
# Gaussian filtering 1600m cut-off wavelength with 1x4 multilooking on Sentinel-1 intensity
...
# Gaussian filtering 1600m cut-off wavelength with 1x4 multilooking
...
phase_goldstein = sbas.goldstein(phase, corr, 64)
...
with mpl_settings({'figure.dpi': 300}):
    sbas.plot_interferogram(intf, caption='Phase, [rad]', POI=sbas.geocode(POI))
