...
char *USAGE = " ALOS_mosaic_ss_2frames prmfile1 grd1 prmfile2 grd2 prmfile3 grd3 prmfile4 grd4 prmfile5 grd5 prmfile6 grd6 prmfile7 grd7 prmfile8 grd8 prmfile9 grd9 prmfile10 grd10 mosaic dec \n\n" 
" USAGE:  \n"
...
int main(int argc, char **argv) {
  ...
  if ((grid11 = GMT_Create_Data (API, GMT_IS_GRID, GMT_IS_SURFACE, GMT_GRID_ALL, NULL, wesn, inc, \
                GMT_GRID_PIXEL_REG, 0, NULL)) == NULL) die("could not allocate grid header","");

  if (GMT_Set_Comment (API, GMT_IS_GRID, GMT_COMMENT_IS_REMARK, "mosaic", grid11)) return EXIT_FAILURE;
