...
/*  ntot is the total number of lines between bursts scaled by the ratio of the fbd_PRF/SW4_PRF */
...
/*   increase the  burst length to ensure complete overlap and shift the ashift back by 1/4 burst */
