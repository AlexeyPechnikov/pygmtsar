...
/*    calculate the unit look vector originated from ground point to satellite 
      in the global cartesian coordinate              */
/* 
  fprintf(stderr,"x y z of the satellite minimum: %f, %f, %f\n",orb_pos[1][xmin],orb_pos[2][xmin],orb_pos[3][xmin]);   */
...
/*      fprintf(stderr,"unit look vector: %f, %f, %f\n",unit_x,unit_y,unit_z);   */
